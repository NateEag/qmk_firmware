 ...
 * |        |      |      | MsUp |      |      |      |           |      |      |      |      |      |      |   F12  |
 * |--------+------+------+------+------+------|      |           |      |------+------+------+------+------+--------|
 * |        | Rclk |MsLeft|MsDown|MsRght| Lclk |------|           |------|      | VolUp| VolDn| Play | Stop |        |
 * |--------+------+------+------+------+------| Del  |           | Del  |------+------+------+------+------+--------|
 * |        |      |      |      |      |      |      |           |      |      |      |      |      |      |        |
 * `--------+------+------+------+------+-------------'           `-------------+------+------+------+------+--------'
 *   |CADel |      |      |      |      |                                       |      |    . |      |      |      |
...
[SYMB] = LAYOUT_ergodox(
       ...
       KC_TRNS,  KC_TRNS, KC_TRNS,KC_TRNS, KC_TRNS, KC_TRNS, KC_F12,
                 KC_TRNS, KC_VOLU, KC_VOLD, KC_MPLY,KC_MSTP, KC_TRNS,
...
/* Keymap 3: Mouse / media key layer
 *
 * TODO Remove this layer. It was a copy/paste and now the functionality
 * I would use from it is on my Fn layer.
 *
 * ,--------------------------------------------------.           ,--------------------------------------------------.
 * |        |      |      |      |      |      |      |           |      |      |      |      |      |      |        |
 * |--------+------+------+------+------+-------------|           |------+------+------+------+------+------+--------|
