 ...
 *
 * I've shifted the pinky keys down by one row because that seems to fit my
 * hands better.
 *
 * ,--------------------------------------------------.           ,--------------------------------------------------.
 * |        |      |      |      |      |      |      |           |      |      |      |      |      |      |        |
...
[PLVR] = KEYMAP(  // layout: layer 1: Steno for Plover
        ...
        KC_NO,  KC_NO,  KC_2,   KC_3,   KC_4,   KC_5,   KC_NO,
        KC_NO,  KC_1,   KC_W,   KC_E,   KC_R,   KC_T,
        KC_NO,  KC_Q,   KC_S,   KC_D,   KC_F,   KC_G,   KC_NO,
        KC_NO,  KC_A,   KC_NO,  KC_NO,  KC_NO,
                                      KC_FN4, KC_NO,
                                           KC_NO,
                                 KC_C,   KC_V,   KC_NO,
        // right hand
        KC_TRNS,  KC_NO,   KC_NO,   KC_NO,  KC_NO,   KC_NO,   KC_TRNS,
        KC_NO,    KC_6,    KC_7,    KC_8,   KC_9,    KC_NO,   KC_TRNS,
                  KC_Y,    KC_U,    KC_I,   KC_O,    KC_0,    KC_LBRC,
        KC_NO,    KC_H,    KC_J,    KC_K,   KC_L,    KC_P,    KC_QUOT,
                           KC_TRNS, KC_TRNS,KC_NO,   KC_SCLN,   KC_NO,
        KC_TRNS, KC_TRNS,
        KC_TRNS,
        KC_NO,  KC_N,   KC_M
),
